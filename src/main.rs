...
fn main() {
    ...
    let trained_perceptron: xor_model::Perceptron = train(perceptron, (x_in,y_out));
    println!("Perceptron: {:?}", trained_perceptron);
    // for i in 0..4{
...
fn train(mut perceptron:xor_model::Perceptron, data:([[f64; 2]; 4], [i8; 4])) -> xor_model::Perceptron{
    let num_iters = 4;
